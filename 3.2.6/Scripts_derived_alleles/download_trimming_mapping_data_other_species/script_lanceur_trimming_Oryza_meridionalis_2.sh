...
module load java
for j in SRR1528445 SRR1528446; do
        cd /sandbox/users/tleroy/AfricanRice/Oryza_meridionalis/$j
        #mkdir Trimmomatic
        ...
        for i in $seqlines; do
            acc=$(echo "/sandbox/users/tleroy/AfricanRice/Oryza_meridionalis/$j/$i")
            outacc=$(echo "/sandbox/users/tleroy/AfricanRice/Oryza_meridionalis/$j/Trimmomatic/$i")
