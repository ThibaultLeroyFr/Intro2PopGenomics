...
listacc=$(echo "ERR2008849 ERR2008850")
...
for j in $listacc; do
    ...
    bash $pathtoscripts/1_mapping.sh $j $pathtodata/$j/Trimmomatic *_1_cleaned.fastq.gz *_2_cleaned.fastq.gz *_1_cleaned_unpaired.fastq.gz *_2_cleaned.unpaired.fastq.gz $refile 1
